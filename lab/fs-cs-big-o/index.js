...
// ANSWER:O(1)constant data size array params don't count
...
// Q: What is the time complexity of this function?
// ANSWER:O(n^2)nested for loop multiplication
...
// Q: What is the space complexity of this function?
// ANSWER:O(n) you are adding number to the answer array n times


// Q: Is it possible to improve this function's space complexity? If it is, write a new function below.
// ANSWER:there is a dot multiplication function fo rarray.that might reduce the complexity
...
// ANSWER: both return the same complexity out put
